// riscv_simulation_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module riscv_simulation_mm_interconnect_0 (
	...
	wire  [101:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> rv32ui_fsmd_0_data_agent:rp_data
	wire          rsp_mux_src_ready;                                                     // rv32ui_fsmd_0_data_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                   // rsp_mux:src_channel -> rv32ui_fsmd_0_data_agent:rp_channel
	...
	wire          cmd_mux_001_src_valid;                                                 // cmd_mux_001:src_valid -> onchip_memory2_0_s2_agent:cp_valid
	wire  [101:0] cmd_mux_001_src_data;                                                  // cmd_mux_001:src_data -> onchip_memory2_0_s2_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                 // onchip_memory2_0_s2_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                               // cmd_mux_001:src_channel -> onchip_memory2_0_s2_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                         // cmd_mux_001:src_startofpacket -> onchip_memory2_0_s2_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                           // cmd_mux_001:src_endofpacket -> onchip_memory2_0_s2_agent:cp_endofpacket
	wire          rv32ui_fsmd_0_data_agent_cp_valid;                                     // rv32ui_fsmd_0_data_agent:cp_valid -> router:sink_valid
	wire  [101:0] rv32ui_fsmd_0_data_agent_cp_data;                                      // rv32ui_fsmd_0_data_agent:cp_data -> router:sink_data
	...
	riscv_simulation_mm_interconnect_0_router router (
	...
	riscv_simulation_mm_interconnect_0_router_001 router_001 (
	...
	riscv_simulation_mm_interconnect_0_router_001 router_002 (
	...
	riscv_simulation_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clock_source_0_clk_clk),                            //       clk.clk
		.reset              (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clock_source_0_clk_clk),                            //       clk.clk
		.reset               (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clock_source_0_clk_clk),                            //       clk.clk
		.reset               (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clock_source_0_clk_clk),                            //       clk.clk
		.reset              (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clock_source_0_clk_clk),                            //       clk.clk
		.reset              (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clock_source_0_clk_clk),                            //       clk.clk
		.reset               (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
