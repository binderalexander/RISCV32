// riscv_simulation_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module riscv_simulation_mm_interconnect_1 (
		input  wire        clock_source_0_clk_clk,                            //                          clock_source_0_clk.clk
		input  wire        rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset, // rv32ui_fsmd_0_reset_n_reset_bridge_in_reset.reset
		input  wire [31:0] rv32ui_fsmd_0_instruction_address,                 //                   rv32ui_fsmd_0_instruction.address
		output wire        rv32ui_fsmd_0_instruction_waitrequest,             //                                            .waitrequest
		input  wire        rv32ui_fsmd_0_instruction_read,                    //                                            .read
		output wire [31:0] rv32ui_fsmd_0_instruction_readdata,                //                                            .readdata
	...
	wire          rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_waitrequest;   // rv32ui_fsmd_0_instruction_agent:av_waitrequest -> rv32ui_fsmd_0_instruction_translator:uav_waitrequest
	wire   [31:0] rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_readdata;      // rv32ui_fsmd_0_instruction_agent:av_readdata -> rv32ui_fsmd_0_instruction_translator:uav_readdata
	wire          rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_debugaccess;   // rv32ui_fsmd_0_instruction_translator:uav_debugaccess -> rv32ui_fsmd_0_instruction_agent:av_debugaccess
	wire   [31:0] rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_address;       // rv32ui_fsmd_0_instruction_translator:uav_address -> rv32ui_fsmd_0_instruction_agent:av_address
	wire          rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_read;          // rv32ui_fsmd_0_instruction_translator:uav_read -> rv32ui_fsmd_0_instruction_agent:av_read
	wire    [3:0] rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_byteenable;    // rv32ui_fsmd_0_instruction_translator:uav_byteenable -> rv32ui_fsmd_0_instruction_agent:av_byteenable
	wire          rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_readdatavalid; // rv32ui_fsmd_0_instruction_agent:av_readdatavalid -> rv32ui_fsmd_0_instruction_translator:uav_readdatavalid
	wire          rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_lock;          // rv32ui_fsmd_0_instruction_translator:uav_lock -> rv32ui_fsmd_0_instruction_agent:av_lock
	wire          rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_write;         // rv32ui_fsmd_0_instruction_translator:uav_write -> rv32ui_fsmd_0_instruction_agent:av_write
	wire   [31:0] rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_writedata;     // rv32ui_fsmd_0_instruction_translator:uav_writedata -> rv32ui_fsmd_0_instruction_agent:av_writedata
	wire    [2:0] rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_burstcount;    // rv32ui_fsmd_0_instruction_translator:uav_burstcount -> rv32ui_fsmd_0_instruction_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                            // rsp_mux:src_valid -> rv32ui_fsmd_0_instruction_agent:rp_valid
	wire  [103:0] rsp_mux_src_data;                                                             // rsp_mux:src_data -> rv32ui_fsmd_0_instruction_agent:rp_data
	wire          rsp_mux_src_ready;                                                            // rv32ui_fsmd_0_instruction_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                          // rsp_mux:src_channel -> rv32ui_fsmd_0_instruction_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                    // rsp_mux:src_startofpacket -> rv32ui_fsmd_0_instruction_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                      // rsp_mux:src_endofpacket -> rv32ui_fsmd_0_instruction_agent:rp_endofpacket
	...
	wire          rv32ui_fsmd_0_instruction_agent_cp_valid;                                     // rv32ui_fsmd_0_instruction_agent:cp_valid -> router:sink_valid
	wire  [103:0] rv32ui_fsmd_0_instruction_agent_cp_data;                                      // rv32ui_fsmd_0_instruction_agent:cp_data -> router:sink_data
	wire          rv32ui_fsmd_0_instruction_agent_cp_ready;                                     // router:sink_ready -> rv32ui_fsmd_0_instruction_agent:cp_ready
	wire          rv32ui_fsmd_0_instruction_agent_cp_startofpacket;                             // rv32ui_fsmd_0_instruction_agent:cp_startofpacket -> router:sink_startofpacket
	wire          rv32ui_fsmd_0_instruction_agent_cp_endofpacket;                               // rv32ui_fsmd_0_instruction_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [103:0] onchip_memory2_0_s1_agent_rp_data;                                            // onchip_memory2_0_s1_agent:rp_data -> router_001:sink_data
	...
	) rv32ui_fsmd_0_instruction_translator (
		.clk                    (clock_source_0_clk_clk),                                                       //                       clk.clk
		.reset                  (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset),                            //                     reset.reset
		.uav_address            (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (rv32ui_fsmd_0_instruction_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (rv32ui_fsmd_0_instruction_waitrequest),                                        //                          .waitrequest
		.av_read                (rv32ui_fsmd_0_instruction_read),                                               //                          .read
		.av_readdata            (rv32ui_fsmd_0_instruction_readdata),                                           //                          .readdata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) rv32ui_fsmd_0_instruction_agent (
		.clk                   (clock_source_0_clk_clk),                                                       //       clk.clk
		.reset                 (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset),                            // clk_reset.reset
		.av_address            (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (rv32ui_fsmd_0_instruction_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (rv32ui_fsmd_0_instruction_agent_cp_valid),                                     //        cp.valid
		.cp_data               (rv32ui_fsmd_0_instruction_agent_cp_data),                                      //          .data
		.cp_startofpacket      (rv32ui_fsmd_0_instruction_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (rv32ui_fsmd_0_instruction_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (rv32ui_fsmd_0_instruction_agent_cp_ready),                                     //          .ready
	...
	riscv_simulation_mm_interconnect_1_router router (
		.sink_ready         (rv32ui_fsmd_0_instruction_agent_cp_ready),          //      sink.ready
		.sink_valid         (rv32ui_fsmd_0_instruction_agent_cp_valid),          //          .valid
		.sink_data          (rv32ui_fsmd_0_instruction_agent_cp_data),           //          .data
		.sink_startofpacket (rv32ui_fsmd_0_instruction_agent_cp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (rv32ui_fsmd_0_instruction_agent_cp_endofpacket),    //          .endofpacket
		.clk                (clock_source_0_clk_clk),                            //       clk.clk
		.reset              (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_1_router_001 router_001 (
	...
	riscv_simulation_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clock_source_0_clk_clk),                            //       clk.clk
		.reset              (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clock_source_0_clk_clk),                            //       clk.clk
		.reset               (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (clock_source_0_clk_clk),                            //       clk.clk
		.reset              (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clock_source_0_clk_clk),                            //       clk.clk
		.reset               (rv32ui_fsmd_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	riscv_simulation_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_clk_0_clk   (clock_source_0_clk_clk),                            // in_clk_0.clk
