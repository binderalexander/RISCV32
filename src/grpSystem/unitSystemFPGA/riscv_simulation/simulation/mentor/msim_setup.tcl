...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "riscv_simulation"
}
...
ensure_lib                               ./libraries/pio_0_s1_agent_rsp_fifo/      
vmap       pio_0_s1_agent_rsp_fifo       ./libraries/pio_0_s1_agent_rsp_fifo/      
ensure_lib                               ./libraries/pio_0_s1_agent/               
vmap       pio_0_s1_agent                ./libraries/pio_0_s1_agent/               
ensure_lib                               ./libraries/rv32ui_fsmd_0_data_agent/     
vmap       rv32ui_fsmd_0_data_agent      ./libraries/rv32ui_fsmd_0_data_agent/     
ensure_lib                               ./libraries/pio_0_s1_translator/          
vmap       pio_0_s1_translator           ./libraries/pio_0_s1_translator/          
...
ensure_lib                               ./libraries/reset_source_0/               
vmap       reset_source_0                ./libraries/reset_source_0/               
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0              
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_1_rsp_mux.sv"                           -work rsp_mux                      
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_1_cmd_mux.sv"                           -work cmd_mux                      
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_1_cmd_demux.sv"                         -work cmd_demux                    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_1_router_001.sv"                        -work router_001                   
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_1_router.sv"                            -work router                       
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0_avalon_st_adapter.vhd"                -work avalon_st_adapter            
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                      
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                             -work rsp_mux                      
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                      
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                             -work cmd_mux                      
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0_router_001.sv"                        -work router_001                   
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0_router.sv"                            -work router                       
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                 -work pio_0_s1_agent_rsp_fifo      
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                            -work pio_0_s1_agent               
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                     -work pio_0_s1_agent               
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                       -work pio_0_s1_translator          
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_1.v"                                    -work mm_interconnect_1            
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/riscv_simulation_mm_interconnect_0.v"                                    -work mm_interconnect_0            
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/altera_avalon_reset_source.vhd"                                          -work reset_source_0               
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/riscv_simulation_pio_0.vhd"                                              -work pio_0                        
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/riscv_simulation_onchip_memory2_0.vhd"                                   -work onchip_memory2_0             
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/riscv_simulation.vhd"                                                                                                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L rsp_mux -L cmd_mux -L cmd_demux -L router_001 -L router -L avalon_st_adapter -L rsp_demux -L pio_0_s1_agent_rsp_fifo -L pio_0_s1_agent -L rv32ui_fsmd_0_data_agent -L pio_0_s1_translator -L rv32ui_fsmd_0_data_translator -L rst_controller -L mm_interconnect_1 -L mm_interconnect_0 -L rv32ui_fsmd_0 -L reset_source_0 -L pio_0 -L onchip_memory2_0 -L clock_source_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
